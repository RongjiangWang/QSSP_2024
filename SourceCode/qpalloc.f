...
c
      real*8,allocatable:: latr(:),lonr(:),tred(:),grndep(:),grnrr0(:)
      integer*4,allocatable:: istfsf(:)
      real*8,allocatable:: sfrsf(:),sftsf(:),sfpsf(:),
     &                     latssf(:),lonssf(:),depssf(:),
     &                     togssf(:),trsssf(:)
      integer*4,allocatable:: istfeq(:)
      real*8,allocatable:: mtteq(:),mppeq(:),mrreq(:),
     &                     mtpeq(:),mpreq(:),mrteq(:),
     &                     latseq(:),lonseq(:),depseq(:),
     &                     togseq(:),trsseq(:)
      logical*2,allocatable:: eqs(:)
      integer*4,allocatable:: istf(:)
