...
c     replace ddat by its discrete fourier transform, if isign = +1;
c     or replace data by nn times its inverse discrete fourier
c     transform, if isign = -1. data is a double complex array of
